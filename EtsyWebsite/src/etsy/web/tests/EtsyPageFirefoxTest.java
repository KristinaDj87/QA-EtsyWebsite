...
public class EtsyPageFirefoxTest {
...
//Test1) Verify that user can log in on Etsy website with Google
		...
		System.setProperty("webdriver.gecko.driver", "C:\\Users\\djurdjic\\eclipse-workspace\\EtsyWebsite\\src\\drivers\\geckodriver.exe" );
...
@Test
//Test 2) Check that some subcategory(ex.Woman's clothing) can be selected from any Category(ex.Clothing & Shoes) 
